...
$query = "
    SELECT t.*, u.fullname, u.email, u.phone,
           tr.amount, tr.status as transaction_status, tr.payment_method, tr.transaction_date
    FROM tickets t
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-mono font-medium text-gray-900"><?= htmlspecialchars($ticket['ticket_code']) ?></div>
                                </td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-sm text-gray-900">#<?= $ticket['transaction_id'] ?></div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <?php if ($ticket['transaction_status'] === 'complete' && !$ticket['is_used']): ?>
                                    ...
                                    <?php endif; ?>
                                    <a href="ticket.php?id=<?= $ticket['id'] ?>" class="text-blue-600 hover:text-blue-900" title="Voir les détails">
