...
<body class="bg-gray-100 min-h-screen">
        ...
        <div class="max-w-6xl mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <a href="index.html" class="hover:text-yellow-300">Tableau de bord</a>
                    <a href="tickets.html" class="hover:text-yellow-300 font-medium">Mes tickets</a>
    ...
    <div class="max-w-6xl mx-auto px-4 py-8">
        <div class="mb-8 flex justify-between items-center">
            ...
            <a href="../payment/" class="bg-yellow-500 hover:bg-yellow-600 text-black font-bold py-2 px-6 rounded-full transition duration-300">
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden">
            <div class="p-6 border-b border-gray-200">
                <h2 class="text-xl font-semibold">Vos tickets (<span id="totalTickets">0</span>)</h2>
            </div>
